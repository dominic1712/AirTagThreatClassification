def threat_classification_tree():
    classification_tree = {
        ...
        '1.1.1 Inadvertent Disabling of the ISA': {
            ...
            'threat': 'Threath: It could occur, that the ISA appears on the home screen at an inconvenient time, where the user mindlessly disregards and disables it. After disabling it, it is gone and will not be triggered again.',
        ...
        '1.1.2 No Manual Scanning Possibility': {
            ...
            'threat': 'Threath: If an iPhone user suspects that someone is stalking him with an AirTag, he can not actively conduct a scan of nearby suspicious AirTags using the ISA feature. He is left with the possibilities of searching for it manually, or waiting for an ISA to appear. ',
            'privacy requirement': '(1) Awareness'
        },
        '1.1.3 Low Reliability': {
            ...
            'threat': 'Threath: The triggering of the ISA has been reported to take too long. For example, if someone is being stalked using an AirTag, and only receives the notification after returning home, the stalker will know where the victim lives. This can seriously endanger the life of the victim.',
            'privacy requirement': '(1) Awareness'
        },
        ...
        '1.2.1 No Background Scanning Possibility': {
            ...
            'threat': 'Threath: Without any previous incidents, a regular person is unlikely to suspect they are being stalked. Therefore, having a tracker detection application, that only runs through manual scans, is quite unreliable and useless on a daily basis. If a stalker is able to place an AirTag with an Android smartphone user without them becoming suspicious or aware of it, the only detection method left is the sound alert feature (1.3), which has been deemed as unreliable.',
            'privacy requirement': '(1) Awareness'
        ...
        '1.2.2 Low Awareness and Detectability': {
            ...
            'threat': "Threath: If an Android victim living inside a big city is suspicious of being stalked with an AirTag, and he conducts a manual scan using the tracker detect app, the app will show nearby Find My devices, yet will not be able to tell, which one is a stalker's AirTag. As there are many Find My devices inside large cities, many devices are shown, yet no suggestive remarks towards finding the stalker AirTag can be delivered by the app. ",
            'privacy requirement': '(1) Awareness'
        },
        '1.3.1 No Active Triggering': {
            'information': 'Information: The sound played by an AirTag can not be actively triggered.',
            'threat': "Threath: If a victim is actively searching for a stalker's AirTag, he is unable to proactively trigger the sound alert, which could simplify the search process. Because of this, he may not find the AirTag at all, which could lead to continuous tracking by the stalker.",
            'privacy requirement': '(1) Awareness'
        },
        '1.3.2 Insufficient Volume Level': {
            'information': 'Information: The volume level of the sound played by the AirTag is too low.',
            'threat': 'Threath: If the sound played by the AirTag is muffled, the user is unable to hear the sound which makes the search process much more difficult. Because of this, he may not find the AirTag at all, which could lead to continuous tracking by the stalker.',
            'privacy requirement': '(1) Awareness'
        },
        '1.3.3 Non-Distinct Sound': {
            ...
            'threat': 'Threath: The sound could be mistaken for a sound played by another device. Therefore, he might not take action to find out where the sound came from which could lead to continuous stalking.',
            'privacy requirement': '(1) Awareness'
        },
        '1.3.4 Short Duration': {
            'information': 'Information: The sound played by an AirTag is too short.',
            'threat': 'Threath: The duration of the sound alert being too short could lead to the user looking for it while the sound is playing, yet not being able to find it in that time. When the auditory aid is gone, it becomes increasingly difficult to find the AirTag. ',
            'privacy requirement': '(1) Awareness'
        },
        '1.3.5 Simple Disabling by Speaker Removal': {
            ...
            'threat': "Threath: By removing a detection mechanism, stalking with AirTags is facilitated from a stalker's perspective and has a higher chance of being undetected by the victim. This concerns especially non-smartphone victims, whose only stalking detection method is the sound-alert feature. ",
            'privacy requirement': '(1) Awareness'
        },
        '1.3.6 Delay': {
            'information': 'Information: There is an unknown delay until the sound alert is triggered.',
            'threat': "Threath: If a victim is unknowingly carrying a stalker's AirTag with him, a delay of the sound alert feature could lead to the victim only being aware of the stalking after he reaches his home. By that time, the stalker already has gathered enough information to continously stalk the victim. ",
            'privacy requirement': '(1) Awareness'
        },
        '1.4.1 RSSI-based Fingerprinting': {
            ...
            'threat': 'Threath: By gaining enough data, a user can pinpoint an AirTag out of a set of AirTags around him. Therefore, it is possible to track the same AirTag for an extensive amount of time.',
        ...
        '1.5.1 Historical Location Access': {
            ...
            'threat': 'Threath: A third-party application can disguise itself as a system-relevant application, for which user priviledges are necessary. If the user grants these priviledges, the system can access the cached keys, which in turn can be used to gain historical location data.',
        ...
        '1.6.1 Linking the Finder Device to the Owner Device in Location Reports': {
            ...
            'threat': 'Threath: Apple could link the finder and owner devices of several location reports, to map, which devices have been near each other. ',
            'privacy requirement': '(9) Anonymity, (10) Unlinkability'
        },
        '1.6.2 Uploading of Fake Reports through OpenHaystack': {
            ...
            'threat': 'Threath: Through fake location reports, imprecise location reports can be created which could be exploited to reduce the accuracy of the downloadable owner location reports. ',
